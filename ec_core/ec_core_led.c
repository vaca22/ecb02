...
static ec_core_sw_timer_e ec_core_led_timer = EC_CORE_SW_TIMER6;
static ec_core_gpio_pin_e ec_core_led_pin = EC_CORE_GPIO_P0;
...
static void ec_core_led_100ms_task(void)
{
    ...
    else if (led_mode == EC_CORE_LED_MODE_OFF)
    {
        ec_core_led_on();
    }
}
